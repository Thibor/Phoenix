...
void AllocTrans(int);
int Attacked(Position *, int, int);
U64 AttacksFrom(Position *, int);
U64 AttacksTo(Position *, int);
int BadCapture(Position *, int);
void BuildPv(int *, int *, int);
int CheckUp(Position*);
void ClearHist(void);
void ClearTrans(void);
void DisplayPv(int,int, int *);
void DoMove(Position *, int, UNDO *);
void DoNull(Position *, UNDO *);
int Evaluate(Position *);
int EvaluateKing(Position *, int);
int EvaluatePawns(Position *, int);
int *GenerateCaptures(Position *, int *);
int *GenerateQuiet(Position *, int *);
U64 GetTimeMs(void);
...
int SearchQuiesce(Position *, int, int, int, int *);
U64 Random64(void);
void ReadLine(char *, int);
int Repetition(Position *);
void ScoreCaptures(MOVES *);
void ScoreQuiet(MOVES *);
int SearchAlpha(Position *, int, int, int, int, int *);
...
void UciLoop(Position*);
void UciCommand(Position*, char*);
void UndoMove(Position *, int, UNDO *);
void UndoNull(Position *, UNDO *);
